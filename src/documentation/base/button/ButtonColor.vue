...
import { buttonProps, buttonColor } from '/@src/data/docs/base/button'
</script>

<template>
  <Section
    id="button-colors-demo"
    bordered-bottom
  >
    <Container>
      <div class="mx-auto max-w-6">
        <div class="pt-4 pb-6">
          <DemoTitle
            title="Button Colors"
            subtitle="Available button colors"
          />
        ...
        <DemoTabs>
          ...
          <template #usage>
            <p class="paragraph rem-95">
              ...
              buttons come in different flavors. You can control button colors
              using the
              <code>color</code>
