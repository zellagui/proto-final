...
import { buttonProps, buttonShapes } from '/@src/data/docs/base/button'
</script>

<template>
  <Section
    id="button-shape-demo"
    bordered-bottom
  >
    <Container>
      <div class="mx-auto max-w-6">
        <div class="pt-4 pb-6">
          <DemoTitle
            title="Button Shape"
            subtitle="Rounded button variation"
          />
        ...
        <DemoTabs>
          ...
          <template #usage>
            <p class="paragraph rem-95">
              ...
              buttons come in different flavors. You can control the button
              shape using the
              <code>rounded</code>
              prop. This prop is a
              <code>boolean</code>
