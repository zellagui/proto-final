...
import {
  ...
  ctaBlockAProps,
  ctaBlockASample,
} from '/@src/data/docs/blocks/cta/blockA'
</script>
  ...
  >
    <Container>
      ...
      <DemoTabs>
        ...
        <template #props>
          <DemoProps :props="ctaBlockAProps.props" />
        </template>
        <template #sample>
          <PrismCode
            language="javascript"
            :code="ctaBlockASample"
          />
        </template>
        <template #usage>
