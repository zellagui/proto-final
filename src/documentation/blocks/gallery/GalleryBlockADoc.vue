...
import {
  ...
  galleryBlockAProps,
  galleryBlockASample,
} from '/@src/data/docs/blocks/gallery/blockA'
</script>
...
<template>
  ...
  >
    <Container>
      ...
      <GalleryBlockA :items="masonryGallery" />
    </Container>
  </Section>
  ...
  >
    <Container>
      ...
      <DemoTabs>
        ...
        <template #props>
          <DemoProps :props="galleryBlockAProps.props" />
        </template>
        <template #sample>
          <PrismCode
            language="javascript"
            :code="galleryBlockASample"
          />
        </template>
        <template #usage>
