...
import {
  ...
  featureBlockDProps,
  featureBlockDSample,
} from '/@src/data/docs/blocks/feature/blockD'
</script>
...
<template>
  ...
  >
    <Container>
      <DemoTitle
        title="Block D"
        subtitle="Feature block D variation 1"
        link="block-d-props"
      />
  ...
  <Section bordered-bottom>
    <Container>
      <DemoTitle
        title="Block D"
        subtitle="Feature block D variation 2"
        link="block-d-props"
      />
  ...
  <Section bordered-bottom>
    <Container>
      <DemoTitle
        title="Block D"
        subtitle="Feature block D variation 3"
        link="block-d-props"
      />
  ...
  >
    <Container>
      <DemoTitle
        title="Block D Props"
        subtitle="Available props for block D"
      />
