...
import {
  ...
  featureBlockLProps,
  featureBlockLSample,
} from '/@src/data/docs/blocks/feature/blockL'
</script>
...
<template>
  ...
  >
    <Container>
      <DemoTitle
        title="Block L"
        subtitle="Feature block L variation 1"
        link="block-l-props"
      />
  ...
  >
    <Container>
      <DemoTitle
        title="Block L Props"
        subtitle="Available props for block L"
      />
      ...
      <DemoTabs>
        ...
        <template #props>
          <DemoProps :props="featureBlockLProps.props" />
        </template>
        <template #sample>
          <PrismCode
            language="javascript"
            :code="featureBlockLSample"
          />
        </template>
        <template #usage>
