...
import {
  ...
  featureBlockKProps,
  featureBlockKSample,
} from '/@src/data/docs/blocks/feature/blockK'
</script>
...
<template>
  ...
  >
    <Container>
      <DemoTitle
        title="Block K"
        subtitle="Feature block K variation 1"
        link="block-k-props"
      />
  ...
  >
    <Container>
      <DemoTitle
        title="Block K Props"
        subtitle="Available props for block K"
      />
      ...
      <DemoTabs>
        ...
        <template #props>
          <DemoProps :props="featureBlockKProps.props" />
        </template>
        <template #sample>
          <PrismCode
            language="javascript"
            :code="featureBlockKSample"
          />
        </template>
        <template #usage>
