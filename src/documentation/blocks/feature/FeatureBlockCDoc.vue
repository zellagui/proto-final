...
import {
  ...
  featureBlockCProps,
  featureBlockCSample,
} from '/@src/data/docs/blocks/feature/blockC'
</script>
...
<template>
  ...
  >
    <Container>
      <DemoTitle
        title="Block C"
        subtitle="Feature block C variation 1"
        link="block-c-props"
      />
  ...
  <Section bordered-bottom>
    <Container>
      <DemoTitle
        title="Block C"
        subtitle="Feature block C variation 2"
        link="block-c-props"
      />
  ...
  <Section bordered-bottom>
    <Container>
      <DemoTitle
        title="Block C"
        subtitle="Feature block C variation 3"
        link="block-c-props"
      />
  ...
  >
    <Container>
      ...
      <DemoTabs>
        ...
        <template #props>
          <DemoProps :props="featureBlockCProps.props" />
        </template>
        <template #sample>
          <PrismCode
            language="javascript"
            :code="featureBlockCSample"
          />
        </template>
        <template #usage>
