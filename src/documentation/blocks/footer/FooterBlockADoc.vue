...
import {
  ...
  footerAProps,
  footerASample,
} from '/@src/data/docs/blocks/footer/blockA'
import { socialLinks } from '/@src/data/blocks/advanced/social'
</script>

<template>
  <Section id="block-a-demo">
    <Container>
      <div class="py-12">
        <DemoTitle
          title="Footer A"
          subtitle="Footer A variation 1"
          link="block-a-props"
        />
      </div>
    </Container>
  ...
  >
    <Container>
      <div class="py-4">
        <DemoTitle
          title="Props"
          subtitle="Footer A available props"
        />
      </div>
