...
import { content5, content6 } from '/@src/data/blocks/content'
import {
  contentBlockC,
  contentBlockCProps,
  contentBlockCSample,
} from '/@src/data/docs/blocks/content/blockC'
</script>
...
<template>
  ...
  >
    <Container>
      <DemoTitle
        title="Block C Props"
        subtitle="Available props for block C"
      />
