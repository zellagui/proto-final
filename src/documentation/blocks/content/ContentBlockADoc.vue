...
import { content, content2 } from '/@src/data/blocks/content'
import {
  contentBlockA,
  contentBlockAProps,
  contentBlockASample,
} from '/@src/data/docs/blocks/content/blockA'
</script>
  ...
  >
    <Container>
      ...
      <DemoTabs>
        ...
        <template #props>
          <DemoProps :props="contentBlockAProps.props" />
        </template>
        <template #sample>
          <PrismCode
            language="javascript"
            :code="contentBlockASample"
          />
        </template>
        <template #usage>
