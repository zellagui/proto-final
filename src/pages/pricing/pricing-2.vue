...
import { pricingIconFeatures } from '/@src/data/blocks/advanced/features'
...
<template>
  <div>
    ...
    <Section color="grey">
      <Container>
        <PricingSoloExtension
          title="Get Paid Bundle"
          subtitle="Expand your plan with loads of additional features"
          :features="[
            'Unlimited projects',
            'Desktop and mobile app',
            'Unlimited tasks',
